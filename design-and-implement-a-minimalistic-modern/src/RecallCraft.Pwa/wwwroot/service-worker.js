// Offline-first service worker for both local testing and published PWA builds.
// iOS Safari requires the app to be served from HTTPS for this to work outside localhost.
...
const cacheVersion = assetsManifest?.version ?? 'dev-v2';
